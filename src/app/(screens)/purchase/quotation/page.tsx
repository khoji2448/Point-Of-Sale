                        ...
                        <div className="invoice-container hidden bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                    ...
                                    <table className="min-w-full bg-white border border-gray-200">
                                        <thead>
                                            <tr className="bg-gray-100">
                                                ...
                                                <th className="py-2 px-4 border-b text-right">Cost Price</th>
                                        ...
                                        <tbody>
                                            {products.map((product) => (
                                                <tr key={product.id} className="border-b">
                                                    ...
                                                    <td className="py-2 px-4 text-right">PKR {product.cost_price}</td>
                                                    <td className="py-2 px-4 text-right">{product.stock}</td>
                                                    <td className="py-2 px-4 text-right font-medium">PKR {(product.cost_price * product.stock).toFixed(2)}</td>
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
                            ...
                            <div className="mb-8 ml-auto max-w-xs">
                                ...
                                <div className="flex justify-between py-2 border-t border-gray-300 mt-2 pt-2">
                                    ...
                                    <span className="text-lg font-bold">PKR {grandTotal.toFixed(2)}</span>
                                </div>
                            </div>

                            <div className="text-center text-sm text-gray-500 mt-4">
                                <p>This is a quotation only. Not a confirmed purchase.</p>
                            </div>
                        </div>
                    </div>
